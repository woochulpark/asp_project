...
<div class="sub_wrap">
	...
	<form name="frm" method="post" action="approval_list.asp">
		...
		<ul class="sch_form">
			...
			<li class="ty02">
				<select name="sType" id="sType" class="select_ty">
					...
					<option value="진행승인요청">진행승인요청</option>
					<option value="진행승인확인">진행승인완료</option>
					<option value="완료승인요청">완료승인요청</option>
					<option value="완료승인확인">승인완료</option>
				</select>
...
<%
		...
		for i=0 to UBound(arrObj,2)
			...
			if Stat2 = "진행승인요청" then
				StatBtn = "<span class='btn_stat ty02'>진행승인요청</span>"
			elseif Stat2 = "진행승인확인" then
				StatBtn = "<span class='btn_stat ty05'>진행승인완료</span>"
			elseif Stat2 = "완료승인요청" then
				StatBtn = "<span class='btn_stat ty02'>완료승인요청</span>"
			elseif Stat2 = "완료승인확인" then
				StatBtn = "<span class='btn_stat ty05'>승인완료</span>"
			end if
