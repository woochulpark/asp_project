<%
	...
	SQL_2 = "select 행사상태, datediff(d, left(행사종료일시,8), convert(varchar(8), getdate(), 112)) 종료경과일 from 행사마스터 (nolock) where 행사번호 = '"& code &"' "
...
%>
<div class="top_btns sort01">
	<a href="javascript:void(0);" class="btn_ty btn_b" onclick="CompleteOK_erp('<%=code %>');">완료승인(요청)</a>
	<!--
...
elseif top_btn = "j" Then
	If hangsa_end_2 >= 1 then
%>
<div class="top_btns sort01">
	<a href="javascript:void(0);" class="btn_ty btn_b" onclick="CompleteOK_erp('<%=code %>');">완료승인(경과)</a>
	<!--<a href="javascript:void(0);" class="btn_ty ty02 btn_b" onclick="Save();">저장</a>-->
</div>
<%
	else
