...
<dl class="top_gl">
	...
	<dd>
        ...
        <a href="intent://addshortcut?url=https://hs.apluslife.co.kr&amp;icon=https://hs.apluslife.co.kr/images/iicon_and.png&amp;title=A&dagger;라이프 의전시스템&amp;serviceCode=sports&amp;version=7#Intent;scheme=naversearchapp;action=android.intent.action.VIEW;category=android.intent.category.BROWSABLE;package=com.nhn.android.search;end" onclick="nclk(this,'fot.shorcut','','',event);" class="u_sc"><span>바로가기 다운로드</span></a>
	<!--&oq=%ED%8C%A8%EC%85%98%ED%92%80-->
	</dd>    
</dl><!--// top_gl -->