...
<div class="sub_wrap">
	...
	<div id="prt">
		...
		<form name="frm" id="frm" method="post" action="reception_sign_ok.asp">
			...
			<input type="hidden" name="SignP1" id="SignP1" />
		</form>
	...
	%>
	<%
		If code = "2021092800010" Then
			'Response.write rc2_1 & "<br><br>"
			'Response.write rc2_2 & "<br><br>"
			'Response.write rc2_3 & "<br><br>"
		End if
	%>
	...
	<%	if input14 = "" then %>		
		<table class="form_ty">
			...
			<colgroup>
				...
				<tr>
					<th scope="row">인수자</th>
					<td colspan="3"><input type="text" id="p1" name="p1" value="" class="input_ty w100"></td>
				</tr>				
		</table>
		<div class="add_pic_sec">
			<canvas id="signature-pad" style="width:100%;height:200px;"></canvas>
		</div>
		<div class="btm_btns sort01">
			<a class="btn_ty ty05 btn_b" id="signature-clear">Clear</a>
		</div>
	<%	else %>
...
<script src="/js/signature_pad-master/js/app2.js"></script>
...
<script language="javascript" type="text/javascript">
	function Save() {
		if ($("#p1").val() == "") {
			...
			document.getElementById("SignP1").value = document.getElementById("p1").value;
		}
