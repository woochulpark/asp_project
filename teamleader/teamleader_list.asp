...
<div class="sub_wrap">
	...
	<form name="frm" method="post" action="teamleader_list.asp">
...
<%
		...
		for i=0 to UBound(arrObj,2)
			...
			if Name = "" then
				StatBtn = "<span class='btn_stat ty03'>배정전</span>"
			else
				StatBtn = "<span class='btn_stat ty05'>배정완료</span>"
			end if
			...
			elseif Stat = "예약" then
				Stat2Btn = "<span class='btn_stat ty06'>예약</span>"
			else
